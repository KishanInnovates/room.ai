...
export default function Header() {
    return (
      <div>
        <header className="flex flex-row xs:flex-row justify-between items-center w-full mt-3 border-b pb-7 sm:px-4 px-2 border-gray-500 gap-2 space-x-96">
          ...
          <a
            ...
            href="https://github.com/KishanInnovates/room.ai"
            target="_blank"
